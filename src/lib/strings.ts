...
const muhyeop = {
  ...
  helpItems: [
    ...
    [
      '족보 항법',
      '↑↓ 행 순회(순환) · ← 접기/부모로 · → 펼치기/자식으로 · Space·C 봉문/개문 · Ctrl+F 念 수소문(검색 필터) · 3 파고들기 · Esc 한 단 위로 · 0 전체로 · Enter 선택→점프 · Delete 베기',
    ],
  ] as [string, string][],
...
export const STRINGS: Record<Tone, StringPack> = {
  ...
  plain: {
    ...
    helpItems: [
      ...
      [
        '아웃라인 키 탐색',
        '↑↓ 행 이동(순환) · ← 접기/부모로 · → 펼치기/하위로 · Space·C 접기/펴기 · Ctrl+F 검색 필터 · 3 선택 하위로 · Esc 한 단계 위로 · 0 전체로 · Enter 선택→이동 · Delete 삭제',
      ],
    ],
    helpQuick: [
      '빈 곳 더블클릭',
