...
const muhyeop = {
  ...
  helpItems: [
    ...
    ['F2', '선택한 쪽지 글 고치기 (Ctrl+Enter도) · 빈 입력 Backspace=베기'],
    ...
    [
      '족보 뷰',
      '위계(트리)로 읽기 — 선택 念은 화면 중앙에 비춰 열림(Shift+3 = 그 가지로 집중) · ↻ 재방문 · ▸ 봉문',
    ],
    ['V / Shift+V', '뷰 순환/역순환 — 강호 캔버스 → 오행진 → 족보 (상단 토글과 동일)'],
    ['1·2·3', '뷰 직행 — 1 강호 · 2 오행진 · 3 족보(선택 念은 화면 중앙) · Shift+3 = 선택 가지로 집중'],
    [
      '오행진 항법',
    ...
    [
      '족보 항법',
      '↑↓ 행 순회(순환) · ← 접기/부모로 · → 펼치기/자식으로 · Space·C 봉문/개문 · Ctrl+F 念 수소문(검색 필터) · Shift+3 선택 가지 집중 · Esc 한 단 위로 · 0 전체로 · Enter 선택→점프 · Delete 베기',
    ],
  ] as [string, string][],
...
export const STRINGS: Record<Tone, StringPack> = {
  ...
  plain: {
    ...
    helpItems: [
      ...
      ['F2', '선택한 노트 편집 (Ctrl+Enter도 가능) · 빈 입력 Backspace=삭제'],
      ...
      [
        '아웃라인 뷰',
        '트리 개요로 읽기 — 선택 노트는 화면 중앙에 비춰 열림(Shift+3 = 그 하위로 집중) · ↻ 재방문 · ▸ 접힘',
      ],
      ['V / Shift+V', '보기 순환/역순환 — 캔버스 → 칸반 → 아웃라인 (상단 토글과 동일)'],
      [
        '1·2·3',
        '보기 바로 가기 — 1 캔버스 · 2 칸반 · 3 아웃라인(선택 노트는 화면 중앙) · Shift+3 = 선택 하위로 집중',
      ],
      [
        '칸반 키 탐색',
      ...
      [
        '아웃라인 키 탐색',
        '↑↓ 행 이동(순환) · ← 접기/부모로 · → 펼치기/하위로 · Space·C 접기/펴기 · Ctrl+F 검색 필터 · Shift+3 선택 하위 집중 · Esc 한 단계 위로 · 0 전체로 · Enter 선택→이동 · Delete 삭제',
      ],
    ],
    helpQuick: [
      '빈 곳 더블클릭',
