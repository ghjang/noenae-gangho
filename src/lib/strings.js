...
export const STRINGS = {
  muhyeop: {
    ...
    helpItems: [
      ...
      ['오행진 항법', '↑↓·←→ 카드 누비기(양끝 순환) · Tab 조준(금테) 중엔 금테만 이동 — Enter면 선택, 다시 Enter면 강호의 그 자리로'],
    ...
    helpSections: [
      ...
      ['서가와 진법', ['서가(겹책)', '오행진 토글', '오행진 항법', 'Ctrl+←→ (오행진)']],
    ],
  ...
  plain: {
    ...
    helpItems: [
      ...
      ['칸반 키 탐색', '↑↓·←→ 카드 이동(끝에서 순환) · Tab 포커스 중엔 포커스만 이동 — Enter = 선택, 다시 Enter = 캔버스 이동'],
    ...
    helpSections: [
      ...
      ['문서와 보기', ['서가(겹책)', '칸반 토글', '칸반 키 탐색', 'Ctrl+←→ (칸반)']],
    ],
