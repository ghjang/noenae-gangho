...
상단 바: 오행 색 팔레트(선택 시 칠하기 · 빈손 클릭 = 붓 색 고르기 — 링 표시가 지금 붓 색 · 호버 = 같은 색 비추기) · +(새 쪽지 — 지금 붓 색으로 핀다) · M↓ 마크(비급.md — 마크다운 개요 출력) · 내보내기/불러오기(JSON) · 강호 비우기(2단 확인) · 封/武 무공봉인 토글(무협 ↔ 일반 말투 전환).
