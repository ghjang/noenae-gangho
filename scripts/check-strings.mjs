...
// 2) 사용 키 — 컴포넌트(App/CanvasView/BoardView/OutlineView)의 정적 t.xxx + store의 STRINGS[톤].xxx + 동적 합성 키
const app =
  read('../src/App.svelte') +
  read('../src/CanvasView.svelte') +
  read('../src/BoardView.svelte') +
  read('../src/OutlineView.svelte');
